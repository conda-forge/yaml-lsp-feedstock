...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/yaml-lsp-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12353&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/yaml-lsp-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `yaml-lsp` can be installed with:

```
conda install yaml-lsp
```

It is possible to list all of the versions of `yaml-lsp` available on your platform with:
